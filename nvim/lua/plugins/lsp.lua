return {
	...
	-- LSP configuration
	{
		...
		config = function()
			...
			-- Resolve the Python interpreter for a given workspace
			local function get_python_path(workspace)
				-- Prefer an activated venv from the shell
				if vim.env.VIRTUAL_ENV then
					return vim.env.VIRTUAL_ENV .. "/bin/python"
				end
				-- Fall back to a .venv at the project root (uv default)
				if workspace then
			...
			-- Python (resolve the project's .venv for imports + intellisense)
